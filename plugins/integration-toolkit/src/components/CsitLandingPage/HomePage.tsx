  ...
  return (
    <Page themeId="home">
      ...
      <div className="hidden-header">
        <Header title="Integration Toolkit" />
      </div>
      <Content>
        ...
        <div className={classes.root}>
          ...
          <Typography>
            The Connected Services Integration Toolkit (CSIT) brings together APIs, 
            data, documentation, and reusable tools into one easy‑to‑use hub.
            <br />
            CSIT helps developers build connected government systems faster and ensures 
          ...
          <HomePageSearchBar
            ...
            placeholder="Search all Intergration Toolkit resources"
          />
        </div>
        ...
        <div className={classes.feedback}>
          ...
          <Typography>
            The Connected Services Integration Toolkit is managed by the Developer Experience
...
export default CsitLandingPage;
