...
This repo also includes a local MkDocs plugin, [techdocs-git-audit-plugin](techdocs-git-audit-plugin), that can render page creator/update audit details from git history. Add it to a TechDocs `mkdocs.yml` with:
